...
-  Сайт -- опубликованный статический сайт с вашим каталогом.

-  Приложение -- приложение Gramax по адресу <https://app.gram.ax>.
...
В приложении кликните ![](./master-klass-12.png){width=72px height=62px} в левом верхнем углу. На главной нажмите ![](./master-klass-13.png){width=88px height=72px} и выберите «Русский»
...
В приложении откройте главную и включите функцию «Облако»
...
Падает «Ошибка в синтаксисе Markdown»

</td>
<td>

Сейчас угадаю: переносите из другой системы блок через копирование-вставку:)

У каждой системы своя нотация Md. Gramax поддерживает:

-  GitHub Flavored Md

-  MDX (XML + Markdown)

-  Legacy (наша кастомная нотация)

Включить нужную нотацию можно в настройках каталога. Но в рамках мастер-класса рекомендую набирать текст руками
...
Закрыл окно и не знаю как попасть на опубликованный сайт

</td>
<td>

В приложении откройте каталог и нажмите «Опубликовано» в правой панели -- ссылка ведет на сайт
...
Поправил слово/добавил статью/поменял заголовок, а на сайте не отобразилось это изменение 

</td>
<td>

В приложении откройте каталог. В правой панели кликните троеточие рядом со статусом «Опубликовано» и выберите «Перепубликовать». Без этого сайт автоматически меняться не будет
